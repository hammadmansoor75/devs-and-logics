...
const Testimonials = () => {
  ...
  return (
    <section className="bg-neutral-100 py-10 dark:bg-black dark:text-white"> 
      <div className="mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
          <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            <h2 className="text-3xl font-bold tracking-tight text-sky-900 dark:text-white sm:text-4xl">
              Top Customer Feedback
            </h2>

            <p className="mt-4 text-black dark:text-white">
            Discover what our clients are saying about their experience with Devs&Logics. Their success stories and feedback highlight the transformative impact our cutting-edge solutions have on businesses across various industries.
            </p>
            ...
            <div className="hidden lg:mt-8 lg:flex lg:gap-4">
              <button
                ...
                className="rounded-full border border-newBlue p-3 text-newBlue transition hover:bg-newBlue hover:text-sky-900"
              >
                <svg
        ...
        <div className="mt-8 flex justify-center lg:hidden">
          ...
          <button
            aria-label="Next slide"
            id="keen-slider-next"
            className="ml-4 rounded-full border border-newBlue p-3 text-newBlue transition hover:bg-newBlue hover:text-sky-900"
          >
            <svg
              className="size-5 rtl:rotate-180"
              fill="none"
